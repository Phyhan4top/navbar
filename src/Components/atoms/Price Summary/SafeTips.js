...
const SafeTips = () => {
  return (
      ...
      <div className="flex flex-col justify-center items-start p-6 bg-[#fefefe] rounded-2xl h-[334px] gap-6 w-[390px]">
        <h1 className='font-bold text-2xl font-[DNSans]'>Safety tips</h1>
        <div className="flex justify-start items-start gap-2 border-b-[2px] border-[#dcdcdc] h-[74px] w-[342px]">
          <svg
          ...
          <p>Avoid sending any prepayments</p>
        </div>
        <div className="flex justify-start items-start gap-2 border-b-[2px] border-[#dcdcdc] h-[74px] w-[342px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <p>Check all the docs and only pay if you're satisfied</p>
        </div>
        <div className="flex justify-start items-start gap-2 border-b-[2px] border-[#dcdcdc] h-[74px] w-[342px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
